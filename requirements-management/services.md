...
```ts twoslash import.meta.vitest name="creating-a-service-1"
...
```ts twoslash import.meta.vitest name="using-the-service-1"
import { Effect, Context } from "effect"
...
```ts twoslash import.meta.vitest name="using-the-service-2"
...
```ts twoslash import.meta.vitest name="providing-a-service-implementation-1"
import { Effect, Context } from "effect"
...
```ts twoslash import.meta.vitest name="extracting-the-service-type-1"
import { Effect, Context } from "effect"
...
```ts twoslash import.meta.vitest name="using-multiple-services-1"
import { Effect, Context } from "effect"
...
```ts twoslash collapse={3-24} import.meta.vitest name="using-multiple-services-2"
import { Effect, Context } from "effect"
...
```ts twoslash collapse={3-24} import.meta.vitest name="using-multiple-services-3"
import { Effect, Context } from "effect"
...
```ts twoslash import.meta.vitest name="optional-services-1"
...
```ts twoslash import.meta.vitest name="handling-services-with-dependencies-1"
import { Effect, Context } from "effect"
