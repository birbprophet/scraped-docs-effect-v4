...
```ts twoslash import.meta.vitest name="creating-a-deferred-1"
...
```ts twoslash import.meta.vitest name="awaiting-1"
...
| `Deferred.done`         | Completes the deferred with an [Exit](/docs/v4/data-types/exit/) value.                                         |
...
| `Deferred.failCause`    | Fails or defects the deferred with a [Cause](/docs/v4/data-types/cause/).                                       |
...
```ts twoslash import.meta.vitest name="completing-1"
import { Effect, Deferred } from "effect"
...
```ts twoslash import.meta.vitest name="completing-2"
import { Effect, Deferred } from "effect"
...
```ts twoslash import.meta.vitest name="checking-completion-status-1"
...
```ts twoslash import.meta.vitest name="common-use-cases-1"
