...
```ts twoslash import.meta.vitest name="forking-effects-1"
...
```ts twoslash import.meta.vitest name="joining-fibers-1"
import { Effect, Fiber } from "effect"
...
```ts twoslash import.meta.vitest name="awaiting-fibers-1"
...
```ts twoslash import.meta.vitest name="interrupting-fibers-1"
import { Effect, Fiber } from "effect"
...
```ts twoslash import.meta.vitest name="interrupting-fibers-2"
import { Effect, Fiber } from "effect"
...
```ts twoslash del={8} ins={9} import.meta.vitest name="interrupting-fibers-3"
import { Effect, Fiber } from "effect"
...
```ts twoslash import.meta.vitest name="composing-fibers-1"
import { Effect, Fiber } from "effect"
...
```ts twoslash import.meta.vitest name="composing-fibers-2"
import { Effect, Fiber } from "effect"
...
```ts twoslash import.meta.vitest name="fork-with-automatic-supervision-1"
...
```ts twoslash import.meta.vitest name="fork-in-local-scope-1"
import { Effect, Console, Schedule } from "effect"
...
```ts twoslash import.meta.vitest name="fork-in-specific-scope-1"
...
```ts twoslash import.meta.vitest name="when-do-fibers-run-1"
...
```ts twoslash ins={14} import.meta.vitest name="when-do-fibers-run-2"
import { Effect, SubscriptionRef, Stream, Console } from "effect"
