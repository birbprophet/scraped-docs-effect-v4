...
```ts twoslash collapse={3-33} import.meta.vitest name="indefinitely-recurring-schedule-1"
import { Array, Duration, Effect, Pull, Schedule } from "effect"
...
```ts twoslash collapse={3-33} import.meta.vitest name="single-recurrence-schedule-1"
import { Array, Duration, Effect, Pull, Schedule } from "effect"
...
```ts twoslash collapse={3-33} import.meta.vitest name="fixed-number-of-recurrences-1"
import { Array, Duration, Effect, Pull, Schedule } from "effect"
...
```ts twoslash collapse={3-33} import.meta.vitest name="recurring-with-delay-between-executions-1"
import { Array, Duration, Effect, Pull, Schedule } from "effect"
...
```ts twoslash collapse={3-33} import.meta.vitest name="fixed-interval-recurrence-1"
import { Array, Duration, Effect, Pull, Schedule } from "effect"
...
```ts twoslash collapse={3-33} import.meta.vitest name="exponential-backoff-schedule-1"
import { Array, Duration, Effect, Pull, Schedule } from "effect"
...
```ts twoslash collapse={3-33} import.meta.vitest name="fibonacci-delay-schedule-1"
import { Array, Duration, Effect, Pull, Schedule } from "effect"
