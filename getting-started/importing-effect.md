...
For detailed installation instructions for platforms like Deno or Bun, refer to the [Installation](/docs/v4/getting-started/installation/) guide, which provides step-by-step guidance.
...
```ts showLineNumbers=false import.meta.vitest name="importing-effect-named"
...
```ts showLineNumbers=false import.meta.vitest name="importing-effect-named-2"
import { Effect } from "effect"
...
```ts showLineNumbers=false import.meta.vitest name="importing-effect-namespace"
...
So, let's take the first step and explore the fundamental concepts of the [The Effect Type](/docs/v4/getting-started/the-effect-type/).
