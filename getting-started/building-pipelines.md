---
url: https://raw.githubusercontent.com/Effect-TS/website/main/apps/web/src/content/docs/v4/getting-started/building-pipelines.mdx
...
```ts twoslash import.meta.vitest name="chaining-arithmetic-operations-1"
import { pipe } from "effect"
...
```ts twoslash import.meta.vitest name="adding-a-service-charge-1"
...
```ts twoslash import.meta.vitest name="replacing-a-value-1"
import { pipe, Effect } from "effect"
...
```ts twoslash import.meta.vitest name="applying-a-discount-1"
import { pipe, Effect } from "effect"
...
```ts twoslash import.meta.vitest name="applying-a-discount-based-on-fetched-amount-1"
import { pipe, Effect } from "effect"
...
```ts twoslash import.meta.vitest name="with-option-1"
...
```ts twoslash import.meta.vitest name="with-result-1"
...
<Aside type="tip" title="Result As Effect">
...
```ts twoslash import.meta.vitest name="logging-a-step-in-a-pipeline-1"
...
```ts twoslash import.meta.vitest name="combining-configuration-and-database-checks-1"
...
```ts twoslash import.meta.vitest name="building-a-transaction-pipeline-1"
...
```ts twoslash collapse={3-15} import.meta.vitest name="using-the-pipe-method-1"
import { Effect } from "effect"
