---
url: https://raw.githubusercontent.com/Effect-TS/website/main/apps/web/src/content/docs/v4/sink/introduction.mdx
title: "Introduction"
...
```ts twoslash import.meta.vitest name="using-a-sink-to-collect-stream-elements-1"
