...
The module provides a single `FileSystem` [service key](/docs/v4/requirements-management/services/), which acts as the gateway for interacting with the filesystem.
...
```ts twoslash import.meta.vitest name="mocking-the-file-system-1"
import { Effect, FileSystem } from "effect"
