...
The module provides a single `Terminal` [service key](/docs/v4/requirements-management/services/), which serves as the entry point to reading from and writing to standard input and standard output.
