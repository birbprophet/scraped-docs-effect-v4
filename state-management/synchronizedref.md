...
<Aside type="tip" title="Learn Ref First">
  ...
  you're not already familiar with `Ref`, it's recommended to read about [the
  Ref concept](/docs/v4/state-management/ref/) first.
</Aside>
...
```ts twoslash import.meta.vitest name="synchronizedref-1"
