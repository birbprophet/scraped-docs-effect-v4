---
url: https://raw.githubusercontent.com/Effect-TS/website/main/apps/web/src/content/docs/v4/state-management/ref.mdx
title: "Ref"
...
```ts twoslash import.meta.vitest name="using-ref-1"
...
```ts twoslash collapse={3-15} import.meta.vitest name="using-ref-2"
import { Effect, Ref } from "effect"
...
```ts twoslash collapse={3-15} import.meta.vitest name="using-ref-in-a-concurrent-environment-1"
import { Effect, Ref } from "effect"
...
You can pass a `Ref` as a [service](/docs/v4/requirements-management/services/) to share state across different parts of your program.

**Example** (Using `Ref` as a Service)

```ts twoslash import.meta.vitest name="using-ref-as-a-service-1"
...
```ts twoslash import.meta.vitest name="sharing-state-between-fibers-1"
