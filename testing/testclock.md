...
```ts twoslash import.meta.vitest name="how-testclock-works-1"
...
```ts twoslash import.meta.vitest name="testing-recurring-effects-1"
...
```ts twoslash import.meta.vitest name="testing-clock-1"
...
```ts twoslash import.meta.vitest name="testing-deferred-1"
